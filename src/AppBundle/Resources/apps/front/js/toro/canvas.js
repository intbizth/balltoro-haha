define(function() {
  ...
  Canvas.prototype.drawText = function(ctx, ARR, x, y) {
    var $scope, i, lineheight, lines, metrics, wdth;
    $scope = this.scope;
  ...
  Canvas.prototype.draw = function() {
    var $scope, canvas, ctx, height, img, newWidth, toro, width;
    $scope = this.scope;
    img = new Image;
    toro = new Image;
    ...
    img.onload = (function(_this) {
      return function(e) {
        ...
        while (i < $scope.memeArray.length) {
          _this.drawText(ctx, $scope.memeArray[i], $scope.memeArray[i].x, $scope.memeArray[i].y);
          i++;
        }
      };
    })(this);
