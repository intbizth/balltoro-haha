define ->
    ...
    Canvas::draw = ->
        ...
        img.onload = (e) =>
            ...
            # Logo
            # ctx.drawImage logo, 20, 20, 90, 80

            # write text
            for text in $scope.memeArray
                @drawText ctx, text, text.x, text.y
